...
class AppBarLegado extends StatefulWidget {
  const AppBarLegado({Key? key}) : super(key: key);

  @override
  State<AppBarLegado> createState() => _AppBarLegadoState();
}
class _AppBarLegadoState extends State<AppBarLegado> {
