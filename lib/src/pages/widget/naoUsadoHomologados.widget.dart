...
class ListaHomologadosWidget extends StatefulWidget {
  const ListaHomologadosWidget({Key? key}) : super(key: key);

  @override
  State<ListaHomologadosWidget> createState() => _ListaHomologadosWidgetState();
}

class _ListaHomologadosWidgetState extends State<ListaHomologadosWidget> {
